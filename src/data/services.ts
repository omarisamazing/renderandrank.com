...
export const services: Service[] = [
  ...
  },
  {
    id: "ai-reputation",
    slug: "ai-reputation",
    title: "AI Reputation & Authority Engine",
    shortDescription:
      "Protect your brand sentiment, earn authoritative 5-star reviews, and ensure generative models describe your business accurately and favorably.",
    fullDescription:
      "AI models aggregate your entire digital footprint to form an opinion about your reliability. We synchronize your reviews, social proof, press mentions, and customer testimonials into a unified authority engine that drives consumer trust and algorithmic preference.",
    icon: "Sparkles",
    stickerColor: "accent-orange",
    badgeText: "Brand Defense",
    metrics: [
      { value: "99.8%", label: "Consistent Entity NAP Across Web" },
      { value: "+85%", label: "Increase in Monthly 5-Star Reviews" },
      { value: "100%", label: "Direct Owner Accountability" },
    ],
    deliverables: [
      "Review management across Google, Yelp, Facebook, BBB, and industry platforms",
      "Sentiment monitoring and proactive negative feedback mitigation",
      "Digital PR and localized press releases to establish authoritative entity backing",
      "Custom branded review generation QR cards and SMS templates",
      "AI summary optimization to ensure ChatGPT highlights your best qualities",
    ],
    process: [
      {
        step: "01",
        title: "Digital Sentiment Analysis",
        desc: "We crawl all web mentions of your business and evaluate how AI engines perceive your reputation.",
      },
      {
        step: "02",
        title: "Automated Review Pipelines",
        desc: "We connect your POS/CRM to trigger gentle review invites at the exact moment of peak customer satisfaction.",
      },
      {
        step: "03",
        title: "Authority Injection",
        desc: "We publish verifiable press mentions and high-tier directory listings to establish undeniable credibility.",
      },
      {
        step: "04",
        title: "Sentiment Defense",
        desc: "We monitor feedback in real-time, responding swiftly with professional brand-aligned answers.",
      },
    ],
    faqs: [
      {
        q: "How does online reputation affect AI search rankings?",
        a: "LLMs prioritize brands with consistent positive sentiment and rich, detailed third-party reviews. When a user asks an AI 'Which dentist in Austin has the best customer care?', the AI analyzes review sentiment and specifics.",
      },
    ],
  },
];
